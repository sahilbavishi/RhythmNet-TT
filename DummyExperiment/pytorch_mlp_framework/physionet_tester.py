...
def get_args():
    ...
    parser.add_argument('--model_type', nargs="?", type=bool, default=True, help='True if this is the titan model')
...
fileName=f"{MLP_path}/MLP/MLP_CW/DummyExperiment/pytorch_mlp_framework/{experiment_name}/saved_models/"
...
fileName=f"{MLP_path}/MLP/MLP_CW/DummyExperiment/pytorch_mlp_framework/{experiment_name}/saved_models/train_model_{epoch}.pth"
...
physionetFile=f"{MLP_path}/MLP/MLP_CW/physionet_csv_files/ecg_records/"
annotationFile=f"{MLP_path}/MLP/MLP_CW/physionet_csv_files/REFERENCE-v3.csv"
