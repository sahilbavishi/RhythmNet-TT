...
def get_args():
    ...
    parser.add_argument('--num_features', nargs="?", type=int, default=3, help='Number of input features (columns in the dataset)')
    parser.add_argument('--num_classes', nargs="?", type=int, default=2, help='Number of output classes (e.g., N and A)')
    parser.add_argument('--dataset_path', nargs="?", type=str, default='ecg_readings.csv', help='Path to the ECG dataset')
